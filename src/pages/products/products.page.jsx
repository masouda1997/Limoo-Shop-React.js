			...
			<PageContainer>
				...
				<div className={` ${st.landingBanner}`}>
					<div className={st._1stBanner}>
						<img
							src="https://www.technolife.ir/image/banner_CenterTwinBanners_npIrqU_55404ba1-ae85-4d65-9cd8-36911406d48a.png"
							alt=" "
						/>
					</div>
					<div className={st._2ndBanner}>
						<img
							src="https://www.technolife.ir/image/banner_CenterTwinBanners_tqGh8a_d0eaa460-6ea6-457a-8ea0-801f6faca1da.png"
							alt=" "
						/>
					</div>
				</div>
